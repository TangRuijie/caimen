...
def resnext(depth, pretrained=None, **kwargs):
    ...
    assert(depth in [50,101], 'The depth is not right')

    # import torchvision
    model = ResNeXt(depth = depth, **kwargs)
    # or_model = torchvision.models.resnext101_32x8d(pretrained=True, progress=True)
    if pretrained is not None:
        pretrained += url_dict['resnext' + str(depth)]

    print('init weight ' + pretrained)

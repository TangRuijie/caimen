...
value_matrix.append([
    ('gated_attention',18, 4),
                    ])

add_params('pos_ex_ratio', [2])

params_list.append('lr')
value_matrix.append([0.01, 0.001])
...
add_params('liu_ratio', [2, 4, 8], pre_items=[('lr', [0.01])])

add_params('neg_ratio', [-1,3], pre_items=[('liu_ratio', [2])])
